      ...
      <Main className={classes.root}>
        <article>
          <Secuence stagger>
            ...
            <p>
              <Text>
                Kod yazarken JetBrains editörlerini kullanıyorum, bilgisayar olarak Monster, monitör olarak
                GamePower kullanıyorum. Yukarıdaki görsel benim evimdeki çalışma alanımdır.
              </Text>
            </p>
          </Secuence>
        </article>
